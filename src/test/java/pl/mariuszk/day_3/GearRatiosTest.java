...
class GearRatiosTest {
    ...
    @MethodSource
    @ParameterizedTest
    void shouldSumPartNumbers_smallSamples(String schematic, int expectedResult) {
        assertThat(new GearRatios().sumPartNumbers(schematic)).isEqualTo(expectedResult);
    }

    private static Stream<Arguments> shouldSumPartNumbers_smallSamples() {
        return Stream.of(
                arguments("""
                        467..114..
                        ...*......
    ...
    void shouldSumPartNumbers_bigTextFile() {
        ...
        // when
        int result = new GearRatios().sumPartNumbers(schematic);
    ...
    // Unfortunately I don't have an idea how to solve it, so I put all puzzle input directly in the test class
