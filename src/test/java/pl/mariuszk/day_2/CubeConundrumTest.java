...
class CubeConundrumTest {
    ...
    // Part II
    @Test
    void sumPowersOfMinimalCubesSets_smallSample() {
        // given
        String input = """
                Game 1: 3 blue, 4 red; 1 red, 2 green, 6 blue; 2 green
                Game 2: 1 blue, 2 green; 3 green, 4 blue, 1 red; 1 green, 1 blue
        ...
        // when
        long result = new CubeConundrum().sumPowersOfMinimalCubesSets(input);
    ...
    @Test
    void sumPowersOfMinimalCubesSets_bigTextFile() throws IOException {
        // given
        String input = Files.readString(Paths.get("src", "test", "resources", "day_2", "games_record.txt"));
        ...
        // then
        Assertions.assertThat(result).isEqualTo(72970L);
    }
}